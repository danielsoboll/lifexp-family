import { WJT_THOUGHT_BUBBLE_XP_THRESHOLD } from './homeWasJetztTunBubble'
...
/** Erstes Erscheinen nach Streak 1 — erfahrene Nutzer (total_xp > Schwellwert). */
export const WJT_BUBBLE_INITIAL_DELAY_OVER_THRESHOLD_MS = 5_000

/** Erstes Erscheinen nach Streak 1 — neue Nutzer. */
