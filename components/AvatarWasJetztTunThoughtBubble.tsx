...
const BUBBLE_CLASS =
  'absolute top-[-6%] left-[60%] z-[2] flex min-w-[min(10rem,58%)] max-w-[64%] translate-x-[2.15rem] flex-col items-center justify-center gap-0.5 rounded-[52%_48%_50%_50%/48%_52%_46%_54%] border-[2.5px] border-slate-900 bg-white px-[1.05rem] py-2.5 shadow-[0_8px_18px_rgb(15_23_42/0.24)] dark:border-slate-100'

/**
 * Kette vom Kopf (mitte-rechts) schräg nach oben-rechts;
 * erster Punkt sitzt am Kopf und ragt rechts über den Bildrand.
 * Nur die Blase ist klickbar — kein Overlay über dem ganzen Portrait.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-center text-[0.6875rem] font-semibold leading-tight text-emerald-700 min-[390px]:text-xs dark:text-emerald-400">
          (klicken)
        </span>
      </button>
    </div>
