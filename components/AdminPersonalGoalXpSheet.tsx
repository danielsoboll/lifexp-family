...
import {
  assignPersonalGoalXp,
  deleteMemberPersonalGoal,
  updatePersonalGoalXp,
...
type AdminPersonalGoalXpSheetProps = {
  familyId: string
...
export default function AdminPersonalGoalXpSheet({
  familyId,
  member,
  memberLabel,
  goalId,
  ...
  const handleDelete = async (): Promise<boolean> => {
    setDeleteBusy(true)
    setDeleteError(null)
    const { error: delError } = await deleteMemberPersonalGoal({
      familyId,
      member,
      goalId,
      canAdmin,
      ...
      >
        ...
        >
          ...
          >
            ...
            <label htmlFor="personal-goal-xp" className="mt-4 mb-1 block text-sm font-semibold">
              Ziel-XP
            </label>
            <input
              id="personal-goal-xp"
